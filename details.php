...
echo "									</li>\n"; 
echo "									<li class=\"current\">\n"; 
echo "										<a href=\"#\">Benchmarking Apps</a>\n"; 
echo "										<ul>\n"; 
echo "											<li><a href=\"details.php?app=spotify\">Spotify</a></li>\n"; 
echo "											<li><a href=\"details.php?app=dropbox\">Dropbox</a></li>\n"; 
echo "											<li><a href=\"details.php?app=whatsapp\">Whatsapp</a></li>\n"; 
echo "										</ul>\n"; 
echo "									</li>\n";  
echo "									\n"; 
echo "								</ul>\n"; 
