...
echo "										<ul>\n"; 
echo "											<li><a href=\"details.php?app=spotify\">Fizy-Spotify</a></li>\n"; 
echo "											<li><a href=\"details.php?app=dropbox\">Depo-Dropbox</a></li>\n"; 
echo "											<li><a href=\"details.php?app=whatsapp\">bip-Whatsapp</a></li>\n"; 
echo "										</ul>\n"; 
echo "									</li>\n";  
echo "									\n"; 
echo "								</ul>\n"; 
